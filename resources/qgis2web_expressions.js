...
function exp_label_BLACKLINE_4_eval_expression(context) {
    // Laenge || ' m'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Laenge')  + ' m');
    } else {
        return (feature.get('Laenge')  + ' m');
    }
}
...
function exp_label_REDLINE_5_eval_expression(context) {
    // "Länge" || ' m'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Länge')  + ' m');
    } else {
        return (feature.get('Länge')  + ' m');
    }
}
...
function exp_label_BLUELINE_6_eval_expression(context) {
    // "Länge" || ' m'
